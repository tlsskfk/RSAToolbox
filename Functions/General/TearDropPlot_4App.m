function [Xs] = TearDropPlot_4App(inData,labels,varargin)
...
MarkerSize = VariableSetter( 'MarkerSize',1,varargin);
...
for i = 1:size(inData,2)
    ...
    tempWidth=scaleVals(tempWidth,1,0,widthRange);
...
scatter(widthData,Data,MarkerSize,colors,'Marker','.','MarkerEdgeAlpha',transparency,'MarkerFaceAlpha',transparency);
hold on
