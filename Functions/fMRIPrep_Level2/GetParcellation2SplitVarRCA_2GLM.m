function [All_RSMs,SplitData,DesignMatrix,AfniInfo,Condition_tVals1,Condition_tVals2,Condition_bVals1,Condition_bVals2] = GetParcellation2SplitVarRCA_2GLM(Events,ConfoundEvents,TimeCourses,ConfoundTCs,boldTCs,boldMasks,ConditionNames,Parcels,TrialNum,SplitVar,varargin)
