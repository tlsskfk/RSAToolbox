function [compiledData,compiled_fmriprep_table,selectind,ROILabels] = CompileRC(ExperimentsDir,fmriprep_table,varargin)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

[AnalysisType] = VariableSetter('AnalysisType',['RCA'],varargin);
[LoadVarName] = VariableSetter('LoadVarName',['RCA_RC'],varargin);
