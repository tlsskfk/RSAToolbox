function [AnalysisParameters] = Compute2SplitVarParcellationRefRCA(fmriprep_table,ExperimentsDir,varargin)
...
if strcmpi(SplitRef,'Yes')
    UseSplitRef=1;
    if isempty(RefInfo)
        [AllPaths_RefRSMs,~,~,~,RefInfo] = GroupDirSearch(ExperimentsDir,'AnalysisTypes','SplitVarRSMs','GroupType','GroupAnalysis','FileNames','ParcelRSMs.mat');
    else
        [AllPaths_RefRSMs,~,~,~,RefInfo] = GroupDirSearch(ExperimentsDir,'AnalysisTypes','SplitVarRSMs','FileNames','ParcelRSMs.mat','GroupType','GroupAnalysis',...
...
RefAppend=[RefInfo.TableNames{1,1},'_',RefInfo.AnalysisNames{1,1},SplitRefAppend];
...
for parcelNum = 1:numParcels
    ...
    if contains(parcelName,'Searchlight')
        ...
        Split1_ParcelRSMs=array2table(MeanRSM,'VariableNames',UseLabels');

        MeanZRSM=nanmean(All_RSMs_Z,3);
        Split1_ParcelZRSMs=array2table(MeanZRSM,'VariableNames',UseLabels');
        ...
        Split1_ParcelRSMs_p50=array2table(MeanCleanRSM,'VariableNames',UseLabels');
        Split1_ParcelZRSMs_p50=array2table(MeanCleanZRSM,'VariableNames',UseLabels');
        ...
        MeanRSM=nanmean(All_RSMs,3);
        Split2_ParcelRSMs=array2table(MeanRSM,'VariableNames',UseLabels');

        MeanZRSM=nanmean(All_RSMs_Z,3);
        Split2_ParcelZRSMs=array2table(MeanZRSM,'VariableNames',UseLabels');
        ...
        Split2_ParcelRSMs_p50=array2table(MeanCleanRSM,'VariableNames',UseLabels');
        Split2_ParcelZRSMs_p50=array2table(MeanCleanZRSM,'VariableNames',UseLabels');        
...
AnalysisName=strrep(RSMsName,'SplitVarRSMs_',['SplitVarRefRCA_',fmriprep_table_name,'_']);
AnalysisName=[AnalysisName,zNormSuffix,zNormRCASuffix,DownSampleSuffix,PermuteSuffix,RefAppend];
...
newDesc='desc-SplitVarRefRCA'; %set file description name
...
for dataInd=useIndicies
    ...
    descript1='desc-SplitVarRefRCA'; %set file description name
    SaveName=strrep(SaveName,'desc-preproc_bold',descript1);
    ...
    for parcelNum=1:numParcels
        ...
        try
            ...
            Split1_RSMs=single(TempLoadData.Split1_RSMs);
            Split2_RSMs=single(TempLoadData.Split2_RSMs);
            rsm_mask=single(TempLoadData.brain_mask{parcelNum});
        catch
        ...
        if UseSplitRef == 1
            if strcmpi(CleanRSMs,'Yes')
                AllRSMs=load(AllPaths_RefRSMs{find(ismember(RefParcelNames,ParcelName)),1},'Split1_ParcelRSMs_p50','Split1_ParcelZRSMs_p50','Split2_ParcelRSMs_p50','Split2_ParcelZRSMs_p50');
                AllRSMs.Split1_ParcelRSMs=AllRSMs.Split1_ParcelRSMs_p50;
                AllRSMs.Split1_ParcelZRSMs=AllRSMs.Split1_ParcelZRSMs_p50;
                AllRSMs.Split2_ParcelRSMs=AllRSMs.Split2_ParcelRSMs_p50;
                AllRSMs.Split2_ParcelZRSMs=AllRSMs.Split2_ParcelZRSMs_p50;                
            else
                AllRSMs=load(AllPaths_RefRSMs{find(ismember(RefParcelNames,ParcelName)),1},'Split1_ParcelRSMs','Split1_ParcelZRSMs','Split2_ParcelRSMs','Split2_ParcelZRSMs');
            end
        else
            if strcmpi(CleanRSMs,'Yes')
                AllRSMs=load(AllPaths_RefRSMs{find(ismember(RefParcelNames,ParcelName)),1},'ParcelRSMs_p50','ParcelZRSMs_p50');
                AllRSMs.Split1_ParcelRSMs=AllRSMs.ParcelRSMs_p50;
                AllRSMs.Split1_ParcelZRSMs=AllRSMs.ParcelZRSMs_p50;
                AllRSMs.Split2_ParcelRSMs=AllRSMs.Split1_ParcelRSMs;
                AllRSMs.Split2_ParcelZRSMs=AllRSMs.Split1_ParcelZRSMs;                
            else
                AllRSMs=load(AllPaths_RefRSMs{find(ismember(RefParcelNames,ParcelName)),1},'ParcelRSMs','ParcelZRSMs');
                AllRSMs.Split1_ParcelRSMs=AllRSMs.ParcelRSMs;
                AllRSMs.Split1_ParcelZRSMs=AllRSMs.ParcelZRSMs;
                AllRSMs.Split2_ParcelRSMs=AllRSMs.Split1_ParcelRSMs;
                AllRSMs.Split2_ParcelZRSMs=AllRSMs.Split1_ParcelZRSMs;                
            end
        end
        if size(AllRSMs.Split1_ParcelRSMs,2)==1
            Split1_Ref_RF=array2table(corr(table2array(AllRSMs.Split1_ParcelRSMs),Split1_RSMs),'VariableNames',UseLabels);
            Split1_RefZ_RF=array2table(corr(table2array(AllRSMs.Split1_ParcelZRSMs),Split1_RSMs),'VariableNames',UseLabels);

            Split2_Ref_RF=array2table(corr(table2array(AllRSMs.Split2_ParcelRSMs),Split2_RSMs),'VariableNames',UseLabels);
            Split2_RefZ_RF=array2table(corr(table2array(AllRSMs.Split2_ParcelZRSMs),Split2_RSMs),'VariableNames',UseLabels);  
            
            SplitDiff_Ref_RF=Split2_Ref_RF-Split1_Ref_RF;
            SplitDiff_RefZ_RF=Split2_RefZ_RF-Split1_RefZ_RF;

            Split1_Ref_RF_Z = Split1_Ref_RF;  
            Split1_RefZ_RF_Z = Split1_RefZ_RF; 
            Split1_Ref_RC=[];
            Split1_RefZ_RC=[];
            Split1_Ref_RC_WholeCM=[];
            Split1_Ref_RC_Degree=[];
            Split1_Ref_RC_Z=[];
            Split1_RefZ_RC_WholeCM=[];
            Split1_RefZ_RC_Degree=[];
            Split1_RefZ_RC_Z=[];

            Split2_Ref_RF_Z = Split2_Ref_RF;  
            Split2_RefZ_RF_Z = Split2_RefZ_RF; 
            Split2_Ref_RC=[];
            Split2_RefZ_RC=[];
            Split2_Ref_RC_WholeCM=[];
            Split2_Ref_RC_Degree=[];
            Split2_Ref_RC_Z=[];
            Split2_RefZ_RC_WholeCM=[];
            Split2_RefZ_RC_Degree=[];
            Split2_RefZ_RC_Z=[];

            SplitDiff_Ref_RF_Z = SplitDiff_Ref_RF;  
            SplitDiff_RefZ_RF_Z = SplitDiff_RefZ_RF; 
            SplitDiff_Ref_RC=[];
            SplitDiff_RefZ_RC=[];
            SplitDiff_Ref_RC_WholeCM=[];
            SplitDiff_Ref_RC_Degree=[];
            SplitDiff_Ref_RC_Z=[];
            SplitDiff_RefZ_RC_WholeCM=[];
            SplitDiff_RefZ_RC_Degree=[];
            SplitDiff_RefZ_RC_Z=[]; 

            save(SaveNames{1,1},'Split1_Ref_RF','Split1_Ref_RC','Split1_RefZ_RF','Split1_RefZ_RC','Split1_Ref_RC_WholeCM','Split1_Ref_RC_Degree','Split1_Ref_RC_Z','Split1_Ref_RF_Z','Split1_RefZ_RC_WholeCM','Split1_RefZ_RC_Degree','Split1_RefZ_RC_Z','Split1_RefZ_RF_Z','Split2_Ref_RF','Split2_Ref_RC','Split2_RefZ_RF','Split2_RefZ_RC','Split2_Ref_RC_WholeCM','Split2_Ref_RC_Degree','Split2_Ref_RC_Z','Split2_Ref_RF_Z','Split2_RefZ_RC_WholeCM','Split2_RefZ_RC_Degree','Split2_RefZ_RC_Z','Split2_RefZ_RF_Z','SplitDiff_Ref_RF','SplitDiff_Ref_RC','SplitDiff_RefZ_RF','SplitDiff_RefZ_RC','SplitDiff_Ref_RC_WholeCM','SplitDiff_Ref_RC_Degree','SplitDiff_Ref_RC_Z','SplitDiff_Ref_RF_Z','SplitDiff_RefZ_RC_WholeCM','SplitDiff_RefZ_RC_Degree','SplitDiff_RefZ_RC_Z','SplitDiff_RefZ_RF_Z');
        else    
            Split1_RCAMat=corr(table2array(AllRSMs.Split1_ParcelRSMs),Split1_RSMs);
            Split2_RCAMat=corr(table2array(AllRSMs.Split2_ParcelRSMs),Split2_RSMs);
            SplitDiff_RCAMat=Split2_RCAMat-Split1_RCAMat;

            Split1_Ref_RF=array2table(Split1_RCAMat(eye(length(Split1_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(Split1_RCAMat+permute(Split1_RCAMat,[2,1]))/2;
            FullMat(eye(length(Split1_RCAMat))==1)=nan;
            Split1_Ref_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels);

            Split2_Ref_RF=array2table(Split2_RCAMat(eye(length(Split2_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(Split2_RCAMat+permute(Split2_RCAMat,[2,1]))/2;
            FullMat(eye(length(Split2_RCAMat))==1)=nan;
            Split2_Ref_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels); 

            SplitDiff_Ref_RF=array2table(SplitDiff_RCAMat(eye(length(SplitDiff_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(SplitDiff_RCAMat+permute(SplitDiff_RCAMat,[2,1]))/2;
            FullMat(eye(length(SplitDiff_RCAMat))==1)=nan;
            SplitDiff_Ref_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels);


            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(Split1_Ref_RC),'ThresholdType','rank','Threshold',0.5);
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(Split1_Ref_RC),'ThresholdType','rank','Threshold',0.25);
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(Split1_Ref_RC),'ThresholdType','rank','Threshold',0.10);
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(Split1_Ref_RC),'ThresholdType','rank','Threshold',0.05);
            ...
            Split1_Ref_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            Split1_Ref_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            Split1_Ref_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            Split1_Ref_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(Split1_Ref_RC))),[],1),'VariableNames',Split1_Ref_RC.Properties.VariableNames,'RowNames',Split1_Ref_RC.Properties.RowNames);
            Split1_Ref_RF_Z = array2table(nan_zscore(table2array(Split1_Ref_RF)')','VariableNames',Split1_Ref_RF.Properties.VariableNames);        

            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(Split2_Ref_RC),'ThresholdType','rank','Threshold',0.5);
            rowNames50=tempResultsByNodeRank50.Properties.VariableNames';
            for nameNum=1:length(rowNames50)
                rowNames50{nameNum,1}=[rowNames50{nameNum,1},'_rank50'];
            end
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(Split2_Ref_RC),'ThresholdType','rank','Threshold',0.25);
            rowNames25=tempResultsByNodeRank25.Properties.VariableNames';
            for nameNum=1:length(rowNames25)
                rowNames25{nameNum,1}=[rowNames25{nameNum,1},'_rank25'];
            end        
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(Split2_Ref_RC),'ThresholdType','rank','Threshold',0.10);
            rowNames10=tempResultsByNodeRank10.Properties.VariableNames';
            for nameNum=1:length(rowNames10)
                rowNames10{nameNum,1}=[rowNames10{nameNum,1},'_rank10'];
            end        
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(Split2_Ref_RC),'ThresholdType','rank','Threshold',0.05);
            rowNames05=tempResultsByNodeRank05.Properties.VariableNames';
            for nameNum=1:length(rowNames05)
                rowNames05{nameNum,1}=[rowNames05{nameNum,1},'_rank05'];
            end        
            ...
            Split2_Ref_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            Split2_Ref_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            Split2_Ref_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            Split2_Ref_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(Split2_Ref_RC))),[],1),'VariableNames',Split2_Ref_RC.Properties.VariableNames,'RowNames',Split2_Ref_RC.Properties.RowNames);
            Split2_Ref_RF_Z = array2table(nan_zscore(table2array(Split2_Ref_RF)')','VariableNames',Split2_Ref_RF.Properties.VariableNames);  

            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(SplitDiff_Ref_RC),'ThresholdType','rank','Threshold',0.5);
            rowNames50=tempResultsByNodeRank50.Properties.VariableNames';
            for nameNum=1:length(rowNames50)
                rowNames50{nameNum,1}=[rowNames50{nameNum,1},'_rank50'];
            end
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(SplitDiff_Ref_RC),'ThresholdType','rank','Threshold',0.25);
            rowNames25=tempResultsByNodeRank25.Properties.VariableNames';
            for nameNum=1:length(rowNames25)
                rowNames25{nameNum,1}=[rowNames25{nameNum,1},'_rank25'];
            end        
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(SplitDiff_Ref_RC),'ThresholdType','rank','Threshold',0.10);
            rowNames10=tempResultsByNodeRank10.Properties.VariableNames';
            for nameNum=1:length(rowNames10)
                rowNames10{nameNum,1}=[rowNames10{nameNum,1},'_rank10'];
            end        
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(SplitDiff_Ref_RC),'ThresholdType','rank','Threshold',0.05);
            rowNames05=tempResultsByNodeRank05.Properties.VariableNames';
            for nameNum=1:length(rowNames05)
                rowNames05{nameNum,1}=[rowNames05{nameNum,1},'_rank05'];
            end        
            ...
            SplitDiff_Ref_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            SplitDiff_Ref_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            SplitDiff_Ref_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            SplitDiff_Ref_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(SplitDiff_Ref_RC))),[],1),'VariableNames',SplitDiff_Ref_RC.Properties.VariableNames,'RowNames',SplitDiff_Ref_RC.Properties.RowNames);
            SplitDiff_Ref_RF_Z = array2table(nan_zscore(table2array(SplitDiff_Ref_RF)')','VariableNames',SplitDiff_Ref_RF.Properties.VariableNames);  

            Split1_RCAMat=corr(table2array(AllRSMs.Split1_ParcelZRSMs),Split1_RSMs);
            Split2_RCAMat=corr(table2array(AllRSMs.Split2_ParcelZRSMs),Split2_RSMs);
            SplitDiff_RCAMat=Split2_RCAMat-Split1_RCAMat;

            Split1_RefZ_RF=array2table(Split1_RCAMat(eye(length(Split1_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(Split1_RCAMat+permute(Split1_RCAMat,[2,1]))/2;
            FullMat(eye(length(Split1_RCAMat))==1)=nan;
            Split1_RefZ_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels);

            Split2_RefZ_RF=array2table(Split2_RCAMat(eye(length(Split2_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(Split2_RCAMat+permute(Split2_RCAMat,[2,1]))/2;
            FullMat(eye(length(Split2_RCAMat))==1)=nan;
            Split2_RefZ_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels); 

            SplitDiff_RefZ_RF=array2table(SplitDiff_RCAMat(eye(length(SplitDiff_RCAMat))==1)','VariableNames',UseLabels);
            FullMat=(SplitDiff_RCAMat+permute(SplitDiff_RCAMat,[2,1]))/2;
            FullMat(eye(length(SplitDiff_RCAMat))==1)=nan;
            SplitDiff_RefZ_RC=array2table(FullMat,'RowNames',UseLabels,'VariableNames',UseLabels);

            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(Split1_RefZ_RC),'ThresholdType','rank','Threshold',0.5);
            rowNames50=tempResultsByNodeRank50.Properties.VariableNames';
            for nameNum=1:length(rowNames50)
                rowNames50{nameNum,1}=[rowNames50{nameNum,1},'_rank50'];
            end
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(Split1_RefZ_RC),'ThresholdType','rank','Threshold',0.25);
            rowNames25=tempResultsByNodeRank25.Properties.VariableNames';
            for nameNum=1:length(rowNames25)
                rowNames25{nameNum,1}=[rowNames25{nameNum,1},'_rank25'];
            end        
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(Split1_RefZ_RC),'ThresholdType','rank','Threshold',0.10);
            rowNames10=tempResultsByNodeRank10.Properties.VariableNames';
            for nameNum=1:length(rowNames10)
                rowNames10{nameNum,1}=[rowNames10{nameNum,1},'_rank10'];
            end        
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(Split1_RefZ_RC),'ThresholdType','rank','Threshold',0.05);
            rowNames05=tempResultsByNodeRank05.Properties.VariableNames';
            for nameNum=1:length(rowNames05)
                rowNames05{nameNum,1}=[rowNames05{nameNum,1},'_rank05'];
            end        
            ...
            Split1_RefZ_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            Split1_RefZ_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            Split1_RefZ_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            Split1_RefZ_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(Split1_RefZ_RC))),[],1),'VariableNames',Split1_RefZ_RC.Properties.VariableNames,'RowNames',Split1_RefZ_RC.Properties.RowNames);
            Split1_RefZ_RF_Z = array2table(nan_zscore(table2array(Split1_RefZ_RF)')','VariableNames',Split1_RefZ_RF.Properties.VariableNames);        

            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(Split2_RefZ_RC),'ThresholdType','rank','Threshold',0.5);
            rowNames50=tempResultsByNodeRank50.Properties.VariableNames';
            for nameNum=1:length(rowNames50)
                rowNames50{nameNum,1}=[rowNames50{nameNum,1},'_rank50'];
            end
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(Split2_RefZ_RC),'ThresholdType','rank','Threshold',0.25);
            rowNames25=tempResultsByNodeRank25.Properties.VariableNames';
            for nameNum=1:length(rowNames25)
                rowNames25{nameNum,1}=[rowNames25{nameNum,1},'_rank25'];
            end        
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(Split2_RefZ_RC),'ThresholdType','rank','Threshold',0.10);
            rowNames10=tempResultsByNodeRank10.Properties.VariableNames';
            for nameNum=1:length(rowNames10)
                rowNames10{nameNum,1}=[rowNames10{nameNum,1},'_rank10'];
            end        
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(Split2_RefZ_RC),'ThresholdType','rank','Threshold',0.05);
            rowNames05=tempResultsByNodeRank05.Properties.VariableNames';
            for nameNum=1:length(rowNames05)
                rowNames05{nameNum,1}=[rowNames05{nameNum,1},'_rank05'];
            end        
            ...
            Split2_RefZ_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            Split2_RefZ_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            Split2_RefZ_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            Split2_RefZ_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(Split2_RefZ_RC))),[],1),'VariableNames',Split2_RefZ_RC.Properties.VariableNames,'RowNames',Split2_RefZ_RC.Properties.RowNames);
            Split2_RefZ_RF_Z = array2table(nan_zscore(table2array(Split2_RefZ_RF)')','VariableNames',Split2_RefZ_RF.Properties.VariableNames);  

            [tempResultsByNodeRank50,tempResultsByCMRank50] = ConnectivityMatrixStats(table2array(SplitDiff_RefZ_RC),'ThresholdType','rank','Threshold',0.5);
            rowNames50=tempResultsByNodeRank50.Properties.VariableNames';
            for nameNum=1:length(rowNames50)
                rowNames50{nameNum,1}=[rowNames50{nameNum,1},'_rank50'];
            end
            ...
            [tempResultsByNodeRank25,tempResultsByCMRank25] = ConnectivityMatrixStats(table2array(SplitDiff_RefZ_RC),'ThresholdType','rank','Threshold',0.25);
            rowNames25=tempResultsByNodeRank25.Properties.VariableNames';
            for nameNum=1:length(rowNames25)
                rowNames25{nameNum,1}=[rowNames25{nameNum,1},'_rank25'];
            end        
            ...
            [tempResultsByNodeRank10,tempResultsByCMRank10] = ConnectivityMatrixStats(table2array(SplitDiff_RefZ_RC),'ThresholdType','rank','Threshold',0.10);
            rowNames10=tempResultsByNodeRank10.Properties.VariableNames';
            for nameNum=1:length(rowNames10)
                rowNames10{nameNum,1}=[rowNames10{nameNum,1},'_rank10'];
            end        
            ...
            [tempResultsByNodeRank05,tempResultsByCMRank05] = ConnectivityMatrixStats(table2array(SplitDiff_RefZ_RC),'ThresholdType','rank','Threshold',0.05);
            rowNames05=tempResultsByNodeRank05.Properties.VariableNames';
            for nameNum=1:length(rowNames05)
                rowNames05{nameNum,1}=[rowNames05{nameNum,1},'_rank05'];
            end        
            ...
            SplitDiff_RefZ_RC_WholeCM=[tempResultsByCMRank50;tempResultsByCMRank25;tempResultsByCMRank10;tempResultsByCMRank05];
            SplitDiff_RefZ_RC_WholeCM.Properties.RowNames={'Rank50','Rank25','Rank10','Rank05'};
            SplitDiff_RefZ_RC_Degree=[tempResultsByNodeRank50;tempResultsByNodeRank25;tempResultsByNodeRank10;tempResultsByNodeRank05];
            SplitDiff_RefZ_RC_Z=array2table(vertRSM2SymRSM(nan_zscore(mat2uppertriuvectormat(table2array(SplitDiff_RefZ_RC))),[],1),'VariableNames',SplitDiff_RefZ_RC.Properties.VariableNames,'RowNames',SplitDiff_RefZ_RC.Properties.RowNames);
            SplitDiff_RefZ_RF_Z = array2table(nan_zscore(table2array(SplitDiff_RefZ_RF)')','VariableNames',SplitDiff_RefZ_RF.Properties.VariableNames); 
...
for parcelNum=1:numParcels
    ...
    if length(UseLabels)>1
        [All_RC{1,1}] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','Split1_Ref_RC',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RC{1,1})
            All_RC{1,1}=table2array(All_RC{1,1});
        end
        [All_RC{1,2}] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','Split2_Ref_RC',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RC{1,2})
            All_RC{1,2}=table2array(All_RC{1,2});
        end   
        [All_RCDiff] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','SplitDiff_Ref_RC',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RCDiff)
            All_RCDiff=table2array(All_RCDiff);
        end  

        [All_RF{1,1}] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','Split1_Ref_RF',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RF{1,1})
            All_RF{1,1}=table2array(All_RF{1,1});
        end
        [All_RF{1,2}] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','Split2_Ref_RF',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RF{1,2})
            All_RF{1,2}=table2array(All_RF{1,2});
        end   
        [All_RFDiff] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','SplitDiff_Ref_RF',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
            'SubjectOrRun',SubjectOrRun,...
            'ParcelName',ParcelName);
        if istable(All_RFDiff)
            All_RFDiff=table2array(All_RFDiff);
        end   

    [Split1_Group_RefRF,Split1_Group_RefRC,Split1_Group_RefRCMat_Ts,Split1_Group_RefRCMat_Means,Split1_RefRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RF{1,1},All_RC{1,1},GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
        'vecName','Split1_RefRF','matName','Split1_RefRC','SavePrefix','Split1_Ref'); 
    if ComputeReliability==1
        Split1_RefRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        Split1_RefRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        Split1_RefRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        Split1_RefRC_losoReliability=ReliabilityResults.Mat_losoReliability;
    end
    [Split2_Group_RefRF,Split2_Group_RefRC,Split2_Group_RefRCMat_Ts,Split2_Group_RefRCMat_Means,Split2_RefRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RF{1,2},All_RC{1,2},GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
       'vecName','Split2_RefRF','matName','Split2_RefRC','SavePrefix','Split2_Ref');
    if ComputeReliability==1
        Split2_RefRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        Split2_RefRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        Split2_RefRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        Split2_RefRC_losoReliability=ReliabilityResults.Mat_losoReliability;    
    end
    [SplitDiff_Group_RefRF,SplitDiff_Group_RefRC,SplitDiff_Group_RefRCMat_Ts,SplitDiff_Group_RefRCMat_Means,SplitDiff_RefRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RFDiff,All_RCDiff,GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
       'vecName','SplitDiff_RefRF','matName','SplitDiff_RefRC','SavePrefix','SplitDiff_Ref');
    if ComputeReliability==1
        SplitDiff_RefRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        SplitDiff_RefRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        SplitDiff_RefRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        SplitDiff_RefRC_losoReliability=ReliabilityResults.Mat_losoReliability;  
    end
    SplitDiffs=[];
    if length(UseLabels)<350
        ...
        save([GroupAnalysisDir,'ThirdOrderRSMs'],'ThirdOrderRSMs');
    end
        [All_RC{1,1}] = CompileND(ExperimentsDir,fmriprep_table,...
            'AnalysisType',AnalysisType,...
            'LoadVarName','Split1_RefZ_RC',...
            'DataType','ByParcellation',...
            'LoadVarFormat','Table',...
            'AnalysisName',AnalysisName,...
            'TableOrArray','Table',...
    ...
    [Split1_Group_RefZRF,Split1_Group_RefZRC,Split1_Group_RefZRCMat_Ts,Split1_Group_RefZRCMat_Means,Split1_RefZRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RF{1,1},All_RC{1,1},GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
        'vecName','Split1_RefZRF','matName','Split1_RefZRC','SavePrefix','Split1_RefZ'); 
    if ComputeReliability==1
        Split1_RefZRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        Split1_RefZRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        Split1_RefZRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        Split1_RefZRC_losoReliability=ReliabilityResults.Mat_losoReliability;
    end
    [Split2_Group_RefZRF,Split2_Group_RefZRC,Split2_Group_RefZRCMat_Ts,Split2_Group_RefZRCMat_Means,Split2_RefZRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RF{1,2},All_RC{1,2},GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
       'vecName','Split2_RefZRF','matName','Split2_RefZRC','SavePrefix','Split2_RefZ');
    if ComputeReliability==1
        Split2_RefZRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        Split2_RefZRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        Split2_RefZRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        Split2_RefZRC_losoReliability=ReliabilityResults.Mat_losoReliability;    
    end
    [SplitDiff_Group_RefZRF,SplitDiff_Group_RefZRC,SplitDiff_Group_RefZRCMat_Ts,SplitDiff_Group_RefZRCMat_Means,SplitDiff_RefZRC_Degree_Table,ReliabilityResults] = GroupParcellationSummaryFigures(All_RFDiff,All_RCDiff,GroupBrainMapsDir,GroupFiguresDir,parcelName,UseMask,UseLabels,'MakeFigs',MakeFigs,'ComputeReliability',ComputeReliability,'MakeBrainMaps',MakeBrainMaps,...
       'vecName','SplitDiff_RefZRF','matName','SplitDiff_RefZRC','SavePrefix','SplitDiff_RefZ');
    if ComputeReliability==1
        SplitDiff_RefZRF_SplitHalfReliability=ReliabilityResults.Vec_SplitHalfReliability;
        SplitDiff_RefZRC_SplitHalfReliability=ReliabilityResults.Mat_SplitHalfReliability;
        SplitDiff_RefZRF_losoReliability=ReliabilityResults.Vec_losoReliability;
        SplitDiff_RefZRC_losoReliability=ReliabilityResults.Mat_losoReliability;  
    end

    save([GroupAnalysisDir,'AnalysisParams_RCA'],'AnalysisParameters');
    save([GroupAnalysisDir,'Group_RF'],'Split1_Group_RefRF','Split2_Group_RefRF','SplitDiff_Group_RefRF','Split1_Group_RefZRF','Split2_Group_RefZRF','SplitDiff_Group_RefZRF','SplitDiffs');
    save([GroupAnalysisDir,'Group_RC'],'Split1_Group_RefRC','Split2_Group_RefRC','SplitDiff_Group_RefRC','Split1_Group_RefZRC','Split2_Group_RefZRC','SplitDiff_Group_RefZRC','SplitDiffs');
    save([GroupAnalysisDir,'Group_RCMat'],'Split1_Group_RefRCMat_Ts','Split1_Group_RefRCMat_Means','Split1_RefRC_Degree_Table','Split2_Group_RefRCMat_Ts','Split2_Group_RefRCMat_Means','Split2_RefRC_Degree_Table','SplitDiff_Group_RefRCMat_Ts','SplitDiff_Group_RefRCMat_Means','SplitDiff_RefRC_Degree_Table','Split1_Group_RefZRCMat_Ts','Split1_Group_RefZRCMat_Means','Split1_RefZRC_Degree_Table','Split2_Group_RefZRCMat_Ts','Split2_Group_RefZRCMat_Means','Split2_RefZRC_Degree_Table','SplitDiff_Group_RefZRCMat_Ts','SplitDiff_Group_RefZRCMat_Means','SplitDiff_RefZRC_Degree_Table');  
    if ComputeReliability==1
        save([GroupAnalysisDir,'Group_ParcelReliability'],'Split1_RefRF_SplitHalfReliability','Split1_RefRC_SplitHalfReliability','Split1_RefRF_losoReliability','Split1_RefRC_losoReliability','Split2_RefRF_SplitHalfReliability','Split2_RefRC_SplitHalfReliability','Split2_RefRF_losoReliability','Split2_RefRC_losoReliability','SplitDiff_RefRF_SplitHalfReliability','SplitDiff_RefRC_SplitHalfReliability','SplitDiff_RefRF_losoReliability','SplitDiff_RefRC_losoReliability','Split1_RefZRF_SplitHalfReliability','Split1_RefZRC_SplitHalfReliability','Split1_RefZRF_losoReliability','Split1_RefZRC_losoReliability','Split2_RefZRF_SplitHalfReliability','Split2_RefZRC_SplitHalfReliability','Split2_RefZRF_losoReliability','Split2_RefZRC_losoReliability','SplitDiff_RefZRF_SplitHalfReliability','SplitDiff_RefZRC_SplitHalfReliability','SplitDiff_RefZRF_losoReliability','SplitDiff_RefZRC_losoReliability');  
    end 
    end
end
